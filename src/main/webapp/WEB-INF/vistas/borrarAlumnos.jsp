...
<h3> Modificación de alumnos</h3>
	<div class= "form">
		<form action="http://localhost:8080/colegio/alumnos/formularioborraralumno" method ="POST">
	 ...
	 <div class="form">
	 	<form action="http://localhost:8080/colegio/alumnos/borraralumno" method="POST" >
			...
			<input type ="text" id="nombre" name="nombre" value="${alumno.nombre}" readonly>
	 		...
	 		<label for="apellido">Apellido Alumno</label>
			<input type ="text" id="apellido" name="apellido" value="${alumno.apellido}" readonly>
			<label for="famNumerosa">Familia Numerosa</label>
			<br>
			...
			<select name="municipios" var="municipios" readonly>
